...
<html>
    ...
    <body>
        <header>
            <h1>Home</h1>
            <h2>${now}</h2>
            <!--  img alt="마카롱" src="/spring1/images/마카롱.jpg" -->
            <!--  img alt="마카롱" src="./images/마카롱.jpg" /-->
            <c:url var="macaron" value="/images/마카롱.jpg" />
            <img alt="마카롱" src="${macaron}" />
            <!--  img src="http://localhost:8080/spring1/images/마카롱.jpg" /-->
        </header>
